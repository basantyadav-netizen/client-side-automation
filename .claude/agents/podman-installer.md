...
description: >
  ...
  TBD — implementation to be added.
tools: Bash, Read
model: sonnet
color: orange
...
[TODO] This agent will install and configure Podman (container runtime) for data engineering.
...
```bash
python3 - "podman-installer" "done" "<short note>" <<'PY'
